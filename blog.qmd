...
Visit this [site](https://www.kaggle.com/) and find an employee dataset that interests you! Follow the steps above to calculate and visualize attrition. Have fun! ![smiley face](download.png)